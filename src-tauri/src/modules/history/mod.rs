...
pub fn history_suggest_multi(
    ...
    suggest_multi(&idx.entries, &line, cwd.as_deref(), limit)
}

#[tauri::command]
pub fn complete_subcommands(
    state: tauri::State<'_, HistoryState>,
    program: String,
    args: Vec<String>,
) -> Vec<String> {
    ...
    subcommand_completions(&idx.entries, &program, &args)
}
