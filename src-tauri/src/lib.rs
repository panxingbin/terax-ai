...
pub fn run() {
    ...
    builder
        ...
        .manage(modules::notes::NotesState::default())
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            workspace::wsl_home,
            workspace::ssh_list_hosts,
            workspace::ssh_save_host,
            workspace::ssh_delete_host,
            workspace::ssh_test_connection,
            workspace::ssh_import_from_config,
            modules::notes::notes_attachment_save,
            modules::notes::notes_attachment_delete,
            modules::notes::notes_attachment_list,
            modules::notes::notes_attachment_read,
            ...
            history::history_suggest_multi,
            history::complete_subcommands,
