...
export default function App() {
  ...
  const { notes, setActive: setActiveNote, init: initNotes } = useNotes();
  ...
  const shortcutHandlers = useMemo<ShortcutHandlers>(
    () => ({
      ...
      "notes.open": () => openSidebarView("notes"),
      "notes.new": async () => {
        await useNotes.getState().create();
        openSidebarView("notes");
      },
                    ...
                    >
                      {sidebarView === "explorer" ? (
                        ...
                        <NoteListPanel
                          onOpenNote={(id) => {
                            setActiveNote(id);
                            // Could also open a note tab here if desired
                          }}
                        />
                      ) : (
                        <SourceControlPanel
